...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
	   ...
	   map1.zoomAndPanTo(zoomLevel, new Location(32.9f, -117.2f));
		...
		double mylat=27.2358942;
		double mylong=78.2061342;
		//Now i will create the map 2 with my latitude an longitude
		map2 = new UnfoldingMap(this,450,50,350,500,provider);
		//now Zoom in and center the map at my location
		map2.zoomAndPanTo(zoomLevel, new Location(mylat,mylong));
		//Now make the map interactive 
